...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    CodeBehind="BC_Chot_inBienBanQT.aspx.cs" Inherits="MTCSYT.BC_Chot_inBienBanQT" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Biên bản quyết toán</h4>
    </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="../Default.aspx">Trang chủ</a></li>
            <li><a href="bc_GiaoNhan2Chieu.aspx">Báo cáo thống kê</a></li>
            <li><a href="bc_GiaoNhan2Chieu.aspx">Biên bản quyết toán</a></li>
        </ol>
    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Category" runat="server">
    <div class="col-md-12">
        ...
        <div class="white-box">
            ...
            <h1 class="m-b-0 box-title">In biên bẢn quyẾt toán</h1>
                                ...
                                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxButton ID="btnXuat" runat="server" Text="In dữ liệu" Width="120px" Theme="Aqua" OnClick="btnXuat_Click">
                                                </dx:ASPxButton>
                                            </td>
                                            <td>
                ...
                <tr>
                    <td width="100%" valign="Top">
                        <dxwtl:ASPxTreeList ID="tlDonVi" runat="server" AutoGenerateColumns="False"
                            Caption="Tổng hợp sản lượng theo phương thức giao nhận" 
                            KeyFieldName="ID" ParentFieldName="ParentId"
                            Width="100%" ClientInstanceName="TreeListOrganization" ClientIDMode="AutoID" Theme="Aqua" >
                            <Images>
