...
namespace MTCSYT
{
    public partial class BC_Chot_inBienBanQT : BasePage
    {
        ...
        {
            Response.Redirect("../Report/Report.aspx?Chinhanh=" + tlDonVi.FocusedNode.Key + "&Loai=7&Thang=" + cmbThang.Value + "&Nam=" + cmbNam.Value + "&ParentId=" + ((CBDN.BC_CHOT_ChiTietResult)(tlDonVi.FocusedNode.DataItem)).ParentId);
            //MTCSYT.SYS_Session session = (MTCSYT.SYS_Session)Session["SYS_Session"];
            //int ma_dviqly = int.Parse(session.User.ma_dviqly + "");
