...
namespace MTCSYT
{
    public partial class bc_Chot_TonThat : BasePage
    {
        ...
        private void loadDanhMuc()
        {
            ...
            grdDVT.DataSource = db.BC_TonThat110ChiTiet(ma_dviqly, int.Parse(cmbThang.Value + ""), int.Parse(cmbNam.Value + ""),cmbCapDienAp.Value+"");
            grdDVT.DataBind();

            var listTong = db.BC_TonThat110(ma_dviqly, int.Parse(cmbThang.Value + ""), int.Parse(cmbNam.Value + ""), cmbCapDienAp.Value + "");
        ...
        protected void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            var lst = db.BC_TonThat110ChiTiet(ma_dviqly, int.Parse("0" + cmbThang.Value), int.Parse("0" + cmbNam.Value), cmbCapDienAp.Value + "").ToList();
            var lsttONG = db.BC_TonThat110(ma_dviqly, int.Parse("0" + cmbThang.Value), int.Parse("0" + cmbNam.Value), cmbCapDienAp.Value + "").ToList();
            ...
            foreach (var chitiet in lst)
            {
                ...
                _range[donghientai + stt, 2].PutValue(chitiet.TenDiemDo);
