<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    CodeBehind="dmTKDiemDo.aspx.cs" Inherits="MTCSYT.dmTKDiemDo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-title">Thống kê danh sách các điểm đo
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <li>
        <span>Thống kê danh sách các điểm đo</span>
    </li>
</asp:Content>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light ">
                <div class="portlet-body">
                    <!-- begin: Demo 1 -->
                    <h3 class=""><b>THỐNG KÊ DANH SÁCH CÁC ĐIỂM ĐO</b></h3>
                        ...
                        <ContentCollection>
                            <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                                <table width="100%" class="tbl_Write">
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Lộ" Width="120px">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td>
                                            <dx:ASPxComboBox ID="cmbLo" runat="server">
                                            </dx:ASPxComboBox>
                                        </td>
                                          <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabel33" runat="server" Text="Kênh giao công tơ"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabel55" runat="server" Text="Kênh nhận công tơ"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                            <dx:ASPxComboBox ID="cmbKenhNhan" runat="server">
                                                <Items>
                                                    <dx:ListEditItem Text="Nhận vào lưới" Value="AN" />
                                                    <dx:ListEditItem Text="Giao ra lưới" Value="AG" />
                                                </Items>
