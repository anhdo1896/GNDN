<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    CodeBehind="DN_TK_CHITIETDIENTP_DienLuc.aspx.cs" Inherits="MTCSYT.DN_TK_CHITIETDIENTP_DienLuc" %>
                ...
                <tr>
                    <td width="100%" valign="Top" colspan="2">
                        <dx:ASPxGridView runat="server" AutoGenerateColumns="False" ID="grdDVT"
                            KeyFieldName="Ngay" OnHtmlCommandCellPrepared="grdDVT_HtmlCommandCellPrepared" Caption="Bảng nhập kế hoạch điện nhận phân bỏ theo tháng"
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="Ngày nhập liệu" FieldName="Ngay" VisibleIndex="1">
                                ...
                                <dx:GridViewDataTextColumn Caption="Ghi chú" VisibleIndex="27" FieldName="GhiChu">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewBandColumn Caption="Điện thực nhận để tính tồn thất" VisibleIndex="23">
                                    <Columns>
                                ...
                                <dx:GridViewBandColumn Caption="Thương phẩm theo phần ghi chỉ số" VisibleIndex="25">
                                    <Columns>
