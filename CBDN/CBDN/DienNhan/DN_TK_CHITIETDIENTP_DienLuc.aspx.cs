...
namespace MTCSYT
{
    public partial class DN_TK_CHITIETDIENTP_DienLuc : BasePage
    {
        ...
        {
            MTCSYT.SYS_Session session = (MTCSYT.SYS_Session)Session["SYS_Session"];
            Response.Redirect("../Report/Report.aspx?DenNgay=" + cmbDenNgay.Value + "&TuNgay=" + cmbTuNgay.Value + "&Thang=" + cmbThang.Value + "&Nam=" + cmbNam.Value + "&Loai=11&DonVi=" + session.User.ma_dviqly);
        ...
        {
            MTCSYT.SYS_Session session = (MTCSYT.SYS_Session)Session["SYS_Session"];
            Response.Redirect("../Report/Report.aspx?DenNgay=" + cmbDenNgay.Value + "&TuNgay=" + cmbTuNgay.Value + "&Thang=" + cmbThang.Value + "&Nam=" + cmbNam.Value + "&Loai=12&DonVi=" + session.User.ma_dviqly+"&TCT=DienLuc");
        }
