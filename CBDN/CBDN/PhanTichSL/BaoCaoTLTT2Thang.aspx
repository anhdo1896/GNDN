<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaoCaoTLTT2Thang.aspx.cs" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    Inherits="CBDN.PhanTichSL.BaoCaoTLTT2Thang" %>
...
<asp:Content ContentPlaceHolderID="Category" ID="Content4" runat="server">
    <div class="col-md-12">
        ...
        <div class="white-box">
            <h1 class="m-b-0 box-title">BIỂU THỐNG KÊ TTĐN TRẠM</h1>
                    ...
                    <td valign="top">
                         <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="grdKH" Caption="TTĐN các TBA chênh lệch giữa 2 tháng liền kề"
                            ...
                            EditFormPreparedEventArgs = "gridView_EditFormPrepared" OnStartRowEditing="grdKH_StartRowEditing" ClientIDMode="AutoID" Theme="Aqua">
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Tên Trạm" FieldName="TEN_TRAM" VisibleIndex="4" Width="150%"  >
                            </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="Công Suất Trạm" FieldName="CSUAT_TRAM" VisibleIndex="5" >
                            </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="Điện nhận luỹ kế" FieldName="DNN" VisibleIndex="6" >
                            </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="ĐNTT lũy kế" FieldName="DNTT" VisibleIndex="7" >
                            </dxwgv:GridViewDataTextColumn>
