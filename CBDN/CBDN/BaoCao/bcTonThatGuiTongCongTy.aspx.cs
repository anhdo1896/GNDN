...
namespace MTCSYT
{
    public partial class bcTonThatGuiTongCongTy : BasePage
    {
        ...
        private void loadDanhMuc()
        {
            ...
            grdDVT.DataSource = db.BC_TonThat110ChiTiet(ma_dviqly, int.Parse(cmbThang.Value + ""), int.Parse(cmbNam.Value + ""));
            grdDVT.DataBind();

            var listTong= db.BC_TonThat110(ma_dviqly, int.Parse(cmbThang.Value + ""), int.Parse(cmbNam.Value + ""));
        ...
        protected void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            var lst = db.BC_TonThat110ChiTiet(ma_dviqly, int.Parse("0" + cmbThang.Value), int.Parse("0" + cmbNam.Value)).ToList();
            var lsttONG = db.BC_TonThat110(ma_dviqly, int.Parse("0" + cmbThang.Value), int.Parse("0" + cmbNam.Value)).ToList();
