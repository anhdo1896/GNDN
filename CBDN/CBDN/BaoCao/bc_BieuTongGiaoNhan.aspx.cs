...
namespace MTCSYT
{
    public partial class bc_BieuTongGiaoNhan : BasePage
    {
        ...
        protected void btXuatDL_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Report/Report.aspx?ChinhNhanh=" + tlDonVi.FocusedNode.Key + "&Loai=2&XacNhan=1&Thang=" + cmbThang.Value + "&Nam=" + cmbNam.Value);
