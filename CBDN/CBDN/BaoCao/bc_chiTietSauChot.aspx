<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    CodeBehind="bc_chiTietSauChot.aspx.cs" Inherits="MTCSYT.bc_chiTietSauChot" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Báo cáo chi tiết sản lượng giao nhận trong tháng</h4>
    </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="../Default.aspx">Trang chủ</a></li>
            <li><a href="bc_chiTietSauChot.aspx">Báo cáo thống kê</a></li>
             <li><a href="bc_chiTietSauChot.aspx">Báo cáo chi tiết sản lượng điện giao nhận trong tháng</a></li>
        </ol>
    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Category" runat="server">
        ...
        <div class="white-box">
            ...
            <h1 class="m-b-0 box-title">Báo cáo chi tiết sản lượng điện giao nhận trong tháng</h1>
