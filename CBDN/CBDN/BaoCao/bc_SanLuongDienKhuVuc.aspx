<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    CodeBehind="bc_SanLuongDienKhuVuc.aspx.cs" Inherits="MTCSYT.bc_SanLuongDienKhuVuc" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <li>
        <span>Báo cáo biến động sản lượng theo khu vực trong tháng</span>
    </li>
</asp:Content>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light ">
                <div class="portlet-body">
                    <!-- begin: Demo 1 -->
                    <h3 class=""><b>BÁO CÁO BIẾN ĐỘNG SẢN LƯỢNG THEO KHU VỰC TRONG THÁNG</b></h3>
