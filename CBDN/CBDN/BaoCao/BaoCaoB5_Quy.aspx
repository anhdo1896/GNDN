...
<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master" AutoEventWireup="true"
    CodeBehind="BaoCaoB5_Quy.aspx.cs" Inherits="CBDN.BaoCao.BaoCaoB5_Quy" %>
        ...
        <div class="white-box">
            ...
            <table class="tbl_Write">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Quý: " />
                    </td>
                    <td>
                        <dx:ASPxComboBox ID="cmbQuy" runat="server" SelectedIndex="0" Width="70px" Theme="Aqua" AutoPostBack="True" OnSelectedIndexChanged="cmbThang_SelectedIndexChanged">
                            <Items>
            ...
            <dx:ASPxPageControl ID="pcTax" runat="server" ActiveTabIndex="2" Width="100%" Theme="Aqua" AccessibilityCompliant="True" EnableCallBacks="True" TabIndex="1">
                <TabPages>
                    ...
                    <dx:TabPage Text="Báo Cáo Theo Tháng">
                        <ContentCollection>
