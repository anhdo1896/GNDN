<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    CodeBehind="bcTonThat.aspx.cs" Inherits="MTCSYT.bcTonThat" %>
    ...
    <div class="col-md-12">
        ...
        <div class="white-box">
                            ...
                            <PanelCollection>
                                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                    <table class="tbl_Write">
                                        <tr>
                                            <td>
                                                <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Chọn đơn vị" Width="120px">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td  colspan="4">
                                                <dx:ASPxComboBox ID="cmbDonVi" runat="server" Width="510px">
                                                </dx:ASPxComboBox>
                                            </td>
                                            <td>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <dx:ASPxGridView runat="server" AutoGenerateColumns="False" ID="grdBieuTong"
                ...
                <tr>
                    <td>
                        <dx:ASPxGridView runat="server" AutoGenerateColumns="False" ID="grdTonHao"
                ...
                <tr>
                    <td>
                        <dx:ASPxGridView runat="server" AutoGenerateColumns="False" ID="grdTonThat"
