...
namespace MTCSYT
{
    public partial class bcTonThatDienLuc_CapDienAp : BasePage
    {
        ...
        private void loadDanhMuc()
        {
            ...
            grdDVT.DataSource = db.BC_TonThat_ChiTietCDA(ma_dviqly, int.Parse(cmbThang.Value + ""), int.Parse(cmbNam.Value + ""), cmbCapDienAp.Value + "");
            grdDVT.DataBind();

            var listTong = db.BC_TonThatCDA(ma_dviqly, int.Parse(cmbThang.Value + ""), int.Parse(cmbNam.Value + ""), cmbCapDienAp.Value + "");
