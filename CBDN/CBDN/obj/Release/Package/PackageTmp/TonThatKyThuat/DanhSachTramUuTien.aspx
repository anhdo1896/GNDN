<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DanhSachTramUuTien.aspx.cs" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    Inherits="CBDN.TonThatKyThuat.DanhSachTramUuTien" %>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <dxe:ASPxButton ID="btnAdd" runat="server" OnClick="btnAdd_Click" Width="20px" Enabled="True">
                            ...
                            <tr>
                                <td>
                                    <dxe:ASPxButton ID="btnRemove" runat="server" OnClick="btnRemove_Click" Width="20px" Enabled="True">
                    ...
                    <td valign="top">
                        <dxwgv:ASPxGridView ID="grdTram_UT" runat="server" AutoGenerateColumns="False" Caption="Danh sách Trạm ưu tiên"
                            ClientInstanceName="grdTram_UT" KeyFieldName="MATRAM" Width="100%" ClientIDMode="AutoID" Theme="Aqua">
                            <Settings GridLines="Horizontal" ShowFilterRow="True" ShowFilterRowMenu="True" />
                            <SettingsText CommandCancel="Thoát" CommandDelete="Xóa" CommandEdit="Sửa" CommandNew="Thêm"
                                CommandUpdate="Cập Nhật" ConfirmDelete="Xóa" />
                            <Styles>
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Mã đơn vị " FieldName="MADVIQLY" VisibleIndex="1" Width="30%">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="Mã Trạm" FieldName="MATRAM" VisibleIndex="2" >
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="Tên Trạm" FieldName="TENTRAM" VisibleIndex="3" >
                            </dxwgv:GridViewDataTextColumn>
                            </Columns>
                            <SettingsBehavior AllowDragDrop="False" AllowSort="False" />
