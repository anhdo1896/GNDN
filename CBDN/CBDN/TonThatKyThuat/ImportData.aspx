<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportData.aspx.cs" EnableEventValidation="false"
                    ...
                    <td colspan="4">
                        <dx:ASPxGridView runat="server" ID="grvView" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Điểm đầu" FieldName="DiemDau" VisibleIndex="1">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Điểm cuối" FieldName="DiemCuoi" VisibleIndex="2">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Mã loại đây" FieldName="MaLoaiDay" VisibleIndex="3">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Chiều dài" FieldName="ChieuDai" VisibleIndex="4">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Hệ số công suất" FieldName="HeSoCongSuat" VisibleIndex="5">
                                </dx:GridViewDataTextColumn>
                            </Columns>
