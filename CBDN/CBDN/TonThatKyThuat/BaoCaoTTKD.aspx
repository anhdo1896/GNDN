                    ...
                    <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                        <table class="tbl_Write">
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <dx:ASPxComboBox ID="cmbMaTram" IncrementalFilteringMode="Contains"
                                        runat="server" SelectedIndex="0" Width="680px" Theme="Aqua" AutoPostBack="True">
                                    </dx:ASPxComboBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Điều kiện lọc" Width="100px">
                                    </dx:ASPxLabel>
                                </td>
                                <td>
                                    <dx:ASPxComboBox ID="cmbDKLoc" runat="server" Width="120px">
                                        <Items>
                                            <dx:ListEditItem Text="Tăng 30%" Value="30" />
                                            <dx:ListEditItem Text="Giảm 30%" Value="-30" />
                                            <dx:ListEditItem Text="Tăng 50%" Value="50" />
                                            <dx:ListEditItem Text="Giảm 50%" Value="-50" />
                                            <dx:ListEditItem Text="Tăng 70%" Value="70" />
                                            <dx:ListEditItem Text="Giảm 70%" Value="-70" />
                                            <dx:ListEditItem Text="Tăng 100%" Value="100" />
                                            <dx:ListEditItem Text="Giảm 100%" Value="-100" />
                                        </Items>
                                    </dx:ASPxComboBox>
