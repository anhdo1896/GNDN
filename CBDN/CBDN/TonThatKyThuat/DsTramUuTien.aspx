<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DsTramUuTien.aspx.cs" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    Inherits="CBDN.TonThatKyThuat.DsTramUuTien" %>
...
<asp:Content ContentPlaceHolderID="Category" ID="Content4" runat="server">
    <div class="col-md-12">
        ...
        <div class="white-box">
            <h1 class="m-b-0 box-title">DANH SÁCH TRẠM ƯU TIÊN ĐÃ TÍNH TOÁN</h1>
                ...
                <tr>
                    <td valign="top">
                         <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="grdKH" Caption="Danh sách trạm ưu tiên đã tính trong tháng"
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Tổn thất kỹ thuật" FieldName="KY_THUAT_DN" VisibleIndex="3" >
                            </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="Tổn thất kinh doanh" FieldName="KINH_DOANH_DN" VisibleIndex="4" >
                            </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="So sánh tổn thất " FieldName="SO_SANH_DN" VisibleIndex="5" >
                            </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption=" Tỷ lệ Tổn thất kỹ thuật" FieldName="KY_THUAT_DN" VisibleIndex="6" >
                            </dxwgv:GridViewDataTextColumn>
