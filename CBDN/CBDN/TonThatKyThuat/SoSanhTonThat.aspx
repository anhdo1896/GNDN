<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPageMTCSYT.Master"
    CodeBehind="SoSanhTonThat.aspx.cs" Inherits="MTCSYT.SoSanhTonThat" %>
                            ...
                            <PanelCollection>
                                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                    <table class="tbl_Write">
                                        ...
                                        <tr>
                                            <td>
                                                <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Lựa chọn tính" Width="100px">
                                                </dx:ASPxLabel>
                                            </td>
                                              <td colspan="2" >
                                                  <dx:ASPxRadioButtonList ID="rdTinhToan" runat="server" SelectedIndex="0" RepeatDirection="Horizontal" TextWrap="False" Width="350px" >
                                                      <Items>
                                                          <dx:ListEditItem Text="Hiển thị tổn thất đã tính" Value="0" Selected="True" />
                                                          <dx:ListEditItem Text="Thực hiện tính lại" Value="1" />
                                                      </Items>
                                                  </dx:ASPxRadioButtonList>
                                              </td>   <td>
                                                <dx:ASPxButton ID="btnTinhTonThat" runat="server" Text="Tính tổn thất" Height="22px" Width="120px"
