...
namespace MTCSYT
{
    public partial class bd_danhSachDiemDoDaNhap : BasePage
    {
        ...
        private void loadDanhMuc()
        {
            ...
            tlDonVi.DataSource = db.DM_DanhSachSanLuongDaNhap(ma_dviqly, int.Parse(cmbThang.Value + ""), int.Parse(cmbNam.Value + ""), txtTimKiem.Text);
            tlDonVi.DataBind();
